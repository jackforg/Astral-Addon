package dev.forg.modules.searcharea.modes;

import dev.forg.modules.searcharea.SearchAreaMode;
import dev.forg.modules.searcharea.SearchAreaModes;
...
public class Rectangle extends SearchAreaMode
{
    ...
    private void printRectangleEstimate()
    {
        ...
        info("Completion will take an estimated %02d hours %02d minutes %02d seconds with entity control at a speed of %.2f and a gap of %d chunks between paths.", hours, minutes, seconds, speedBPS, searchArea.rowGap.get());
    }
