...
import dev.forg.mixin.accessor.AnvilScreenAccessor;
import net.minecraft.client.gui.screen.ingame.AnvilScreen;
import meteordevelopment.meteorclient.utils.player.InvUtils;
import meteordevelopment.meteorclient.events.world.TickEvent;
import meteordevelopment.meteorclient.systems.modules.Module;
import dev.forg.mixin.accessor.AnvilScreenHandlerAccessor;
...
public class StashBrander extends Module {
    public StashBrander() { super(forg.AUTOMATION, "StashBrander","Allows you to automatically rename items in bulk when using anvils."); }
    ...
    private boolean hasValidItems(AnvilScreenHandler handler) {
        ...
        for (int n = 0; n < mc.player.getInventory().getMainStacks().size() + ANVIL_OFFSET; n++) {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (!hasValidItems(anvil)) finished();
            ...
            // fill input 1
            for (int n = ANVIL_OFFSET; n < mc.player.getInventory().getMainStacks().size() + ANVIL_OFFSET; n++) {
