...
public class AdBlocker extends Module {
    public AdBlocker() { super(forg.UTILITY, "AdBlocker", "Blocks advertisers in chat."); }
                ...
                if (!ignoreStyle.get().equals(IgnoreStyle.None)) {
                    ...
                    if (name.isBlank()) {
                        ...
                        for (String culprit : responsible) {
                            ...
                            mc.getNetworkHandler().sendChatCommand(cmd + " " + culprit);
                        }
                    } else {
                        mc.getNetworkHandler().sendChatCommand(cmd + " " + name);
                    }
                }
                break;
            }
