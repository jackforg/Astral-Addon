...
import static dev.forg.utils.MeteoristUtils.removeInvalidChars;
...
public class MeteoristConfigManager {
    ...
    public static File getFolderPath(Module module) {
        return new File(Paths.get(FabricLoader.getInstance().getGameDir().toString(), "forg-addon", removeInvalidChars(module.name)).toString());
    }
